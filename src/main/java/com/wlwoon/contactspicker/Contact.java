...
public class Contact implements Parcelable{
	...
	public static final String isMultipleChoice = "isMultipleChoice";
	public static final String listContacts = "listContacts";
	...
	protected Contact(Parcel in) {
		id = in.readString();
		name = in.readString();
		emails = in.createTypedArrayList(ContactEmail.CREATOR);
		numbers = in.createTypedArrayList(ContactPhone.CREATOR);
